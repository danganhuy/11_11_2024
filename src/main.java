...
public class main {
    public static void main(String[] args) {
        ...
        books[0] = new ProgrammingBook(1, "How to CSharp", 121, "A", "CSharp", ".Net");
        books[1] = new ProgrammingBook(2, "Make game with Unity", 137, "R", "CSharp", ".Net");
        books[2] = new ProgrammingBook(3, "Program with Java", 83, "D", "Java", "Spring MVC");
        books[3] = new FictionBook(4, "Ghost in the shell", 100, "V", "Sci-fi");
        books[4] = new FictionBook(5, "Dune", 149, "J", "Sci-fi");
